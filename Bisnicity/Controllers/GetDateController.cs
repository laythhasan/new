...
namespace Bisnicity.Controllers
{
    ...
    public class GetDateController : ControllerBase
    {
        ...
        public GetDateController(IBisnicity<Info> bisnicity, IBisnicity<OurServices> _ourserv, IBisnicity<Services> _serv, IBisnicity<Templete> _Temp, DataContext _db)
        {
            Info = bisnicity;
            ourserv = _ourserv;
            serv = _serv;
